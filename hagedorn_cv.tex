...
\section{Research Visits}
    \cventry{02/2018 \\-- 04/2018}
					...
					{Funded by HPC-Europa3\\
                     In collaboration with the Irish Centre for High-End Computing (ICHEC) and the University of Edinburgh, I implement high-performance code generation for emerging HPC applications like acoustics simulations and Ground Penetrating Radar (GPR) using Lift.
					}
	...
	\cventry{07/2017 \\-- 09/2017}
					...
					{Funded by HiPEAC\\
                     ...
                     A paper describing the results of this and our previous collaborations is nominated for the best paper award at the prestigious International Symposium on Code Generation and Optimization (CGO)~\cite{cgo2018}
					}
...
\cvitem{2018}{SPLS - \textit{Scottish Programming Languages Seminar}, Glasgow, UK}
...
\section{Supervised Undergraduate and Master Students}
    ...
    \cvitem{since 01/2018}{Maurice Heine (Undergraduate): \emph{Implementation of a Visualization Tool for Lift Programs}}
    \cvitem{since 01/2018}{Martin Lücke (Master): \emph{Efficient Implementation of Geometric Multigrid Operations in Lift}}
